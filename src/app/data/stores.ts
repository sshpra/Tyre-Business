...
export const stores: Store[] = [
  ...
  },
  {
    ...
    gst: "13AUQPS7121L3Z4",
    shortDescription: "Premium Yokohama tyres and expert service",
    fullDescription:
      "Our Yokohama Tyre outlet offers the full range of Yokohama products with specialized services including fitting, balancing, and alignment. Our team helps you choose the right tyres for your vehicle and driving needs.",
    images: [shop3Img, shop2Img, shop5Img],
    address: "Naga Hospital Rd, near Naga Hospital Authority",
    city: "Kohima",
    state: "Nagaland",
    zip: "797001",
    phone: "6909318805",
    ...
    story:
      "If Yokohama is your brand, this is your store. As an authorised Yokohama dealer we carry the complete product line-up — from the fuel-saving BluEarth series to the high-performance ADVAN range. Located on Naga Hospital Road for easy access, this outlet is staffed by specialists who understand every aspect of Yokohama's tyre technology. Whether you drive a compact hatchback or a rugged off-roader, we'll match you with the perfect Yokohama tyre and fit it with precision.",
    whyChooseUs: [
      {
        title: "Authorised Yokohama Dealer",
        description:
          "Full factory warranty and the complete Yokohama catalogue at your fingertips.",
      },
      {
        title: "Precision Alignment",
        description:
          "State-of-the-art alignment equipment ensures every tyre performs at its best.",
      },
      {
        title: "Expert Guidance",
        description:
          "Staff trained directly by Yokohama to recommend the ideal fitment.",
      },
      {
        title: "Convenient Location",
        description:
          "Easy to find on Naga Hospital Road with ample parking space.",
      },
    ],
  },
  {
